...
public class Contabilidade {
	...
	private String cnpj;
	private String ies_parceiro;
	private int cod_parceria;
	private int cod_endereco;
	public Contabilidade(int id_contabilidade, String nome_contabilidade, String cnpj, String ies_parceiro,
	...
	public String getIes_parceiro() {
		return ies_parceiro;
	}
	public void setIes_parceiro(String ies_parceiro) {
		this.ies_parceiro = ies_parceiro;
	}
