...
public class AdicionarTipoCertificado extends javax.swing.JPanel {
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        try {
            ...
            TipoCertificado tipo = new TipoCertificado(textoDescricao);
            if (e.cadastro(tipo)) {
                JOptionPane.showMessageDialog(null, "Novo Tipo de certificado salvo com sucesso");
                retornarLista();
            }
    ...
    private void retornarLista() {
        ...
        try {
            TipoCertificadoRegrasNegocio tipo = new TipoCertificadoRegrasNegocio();
            LinkedList<TipoCertificado> lista = tipo.listaTipoCertificado();
