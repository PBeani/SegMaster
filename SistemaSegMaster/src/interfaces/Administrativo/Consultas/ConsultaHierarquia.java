 ...
 * @author pedro
 */
public class ConsultaHierarquia extends javax.swing.JPanel {

    /**
     * Creates new form ConsultaHierarquia
     */
                    ...
                    if (i == 1) {
                        try {
                            ...
                            try {
                                ...
                                montaTabelaHierarquia(listaHierarquia);
                            } catch (Exception ex) {
    ...
    private void initComponents() {
        ...
        addHierarquia = new javax.swing.JLabel();
        ...
        addHierarquia.setBackground(new java.awt.Color(0, 204, 255));
        addHierarquia.setFont(new java.awt.Font("Roboto", 1, 14)); // NOI18N
        addHierarquia.setForeground(new java.awt.Color(255, 255, 255));
        addHierarquia.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        addHierarquia.setText("Adicionar Hierarquia");
        addHierarquia.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        addHierarquia.setOpaque(true);
        addHierarquia.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                addHierarquiaMouseClicked(evt);
            }
        });

        jLabel1.setFont(new java.awt.Font("Roboto", 1, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 153, 0));
        jLabel1.setText("Hierarquia de Certificado");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(addHierarquia, javax.swing.GroupLayout.PREFERRED_SIZE, 184, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(46, 46, 46)
                        .addComponent(addHierarquia, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(18, 18, 18)
    ...
    private void addHierarquiaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addHierarquiaMouseClicked
        ...
        AdicionarHierarquia panelAdm = new AdicionarHierarquia(parent);
        ...
        parent.add(painelConsultas);
        parent.setLastPanel(content);
    }//GEN-LAST:event_addHierarquiaMouseClicked


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JLabel addHierarquia;
