...
public class EditarTipoContato extends javax.swing.JPanel {
    ...
    int cod;
    public EditarTipoContato(PainelAdministrativo p) {
        parent = p;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Editar Tipo de Contato");
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        try {
            ...
            TipoContato tipo  = new TipoContato(cod, textoDescricao);
            if (e.altera(tipo)) {
    ...
    public TipoContato dados(int codigo) {
        try {
            TipoContatoRegrasNegocio regra = new TipoContatoRegrasNegocio();
            TipoContato tipo = regra.seleciona(codigo);
            descricao.setText(tipo.getDesc_tipo_contato());
            cod = codigo;
            return tipo;
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    private void retornarLista() {
        ...
        try {
            ...
            LinkedList<TipoContato> lista = regras.listaTipoContato();
