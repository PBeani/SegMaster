 ...
 * @author pedro
 */
public class EditarFormaPagamento extends javax.swing.JPanel {
    ...
    int cod;
    public EditarFormaPagamento(PainelAdministrativo p) {
        parent = p;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Editar Forma de Pagamento");
...
public FormaPagamento dados(int codigo){        
        try {
            Forma_pagamentoRegrasNegocio regra = new Forma_pagamentoRegrasNegocio();
            FormaPagamento forma = regra.seleciona(codigo);
            descricao.setText(forma.getDesc_forma_pagamento());
            cod = codigo;
            return forma;
        } catch (Exception ex) {                
            ex.printStackTrace();
