 ...
 * @author pedro
 */
public class EditarHierarquia extends javax.swing.JPanel {
    ...
    int cod;
    public EditarHierarquia(PainelAdministrativo p) {
        parent = p;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Editar Hierarquia de Certificado");
    ...
    public Hierarquia dados(int codigo) {
        try {
            HierarquiaRegrasNegocio regra = new HierarquiaRegrasNegocio();
            Hierarquia hierarquia = regra.seleciona(codigo);
            descricao.setText(hierarquia.getDesc_hierarquia());
            cod = codigo;
            return hierarquia;
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    private void retornarLista() {
        ...
        ConsultaHierarquia panelAdm = new ConsultaHierarquia(parent);
