 ...
 * @author pedro
 */
public class EditarStatusComissao extends javax.swing.JPanel {
    ...
    int cod;
    public EditarStatusComissao(PainelAdministrativo p) {
        parent = p;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Editar Status de Comissão");
    ...
    public StatusComissao dados(int codigo) {
        try {
            StatusRegrasNegocio regra = new StatusRegrasNegocio();
            StatusComissao status = regra.seleciona(codigo);
            descricao.setText(status.getDesc_status_comissao());
            cod = codigo;
            return status;
        } catch (Exception ex) {
            ex.printStackTrace();
