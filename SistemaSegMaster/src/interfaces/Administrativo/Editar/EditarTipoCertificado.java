 ...
 * @author pedro
 */
public class EditarTipoCertificado extends javax.swing.JPanel {

    /**
     * Creates new form AdicionarTipoCertificado
     */
    
    PainelAdministrativo parent;
    int cod;
    public EditarTipoCertificado(PainelAdministrativo p) {
        parent = p;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Editar Tipo de Certificado");
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        try {
            ...
            TipoCertificadoRegrasNegocio e = new TipoCertificadoRegrasNegocio();
            TipoCertificado tipo  = new TipoCertificado(cod, textoDescricao);
            if (e.altera(tipo)) {
    ...
    public TipoCertificado dados(int codigo) {
        try {
            TipoCertificadoRegrasNegocio regra = new TipoCertificadoRegrasNegocio();
            TipoCertificado tipo = regra.seleciona(codigo);
            descricao.setText(tipo.getDesc_tipo_certificado());
            cod = codigo;
            return tipo;
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    private void retornarLista() {
        ...
        try {
            ...
            LinkedList<TipoCertificado> lista = regras.listaTipoCertificado();
            panelAdm.montaTabelaTipoCertificado(lista);
