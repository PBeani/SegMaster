 ...
 * @author pedro
 */
public class EditarTipoCliente extends javax.swing.JPanel {

    /**
     * Creates new form AdicionarTipoCliente
     */
    
    PainelAdministrativo parent;
    int cod;
    
    public EditarTipoCliente(PainelAdministrativo p) {
        parent = p;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Editar Tipo de Cliente");
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        try {
            ...
            TipoCliente tipo  = new TipoCliente(cod, textoDescricao);
            if (e.altera(tipo)) {
    ...
    public TipoCliente dados(int codigo) {
        try {
            TipoClienteRegrasNegocio regra = new TipoClienteRegrasNegocio();
            TipoCliente tipo = regra.seleciona(codigo);
            descricao.setText(tipo.getDesc_tipo_cliente());
            cod = codigo;
            return tipo;
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    private void retornarLista() {
        ...
        ConsultaTipoCliente panelAdm = new ConsultaTipoCliente(parent);
        ...
        try {
            ...
            LinkedList<TipoCliente> lista = regras.listaTipoCliente();
